...
@NamedQueries({
	...
	@NamedQuery(name="Solicitud.findAudiencias", query="SELECT DISTINCT s FROM Solicitud s WHERE s.fecha between :fechaInicial AND :fechaFinal AND s.estado like 'AUDIENCIA%' ORDER BY s.fecha"),
