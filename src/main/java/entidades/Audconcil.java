...
@Entity
@NamedQueries({
	@NamedQuery(name="Audconcil.findConciliadorFecha", query="SELECT DISTINCT a FROM Audconcil a WHERE a.idconciliador = :identificacion AND a.estadoaudiencia like :estado ORDER BY a.radicado,a.fechaaudiencia"),
