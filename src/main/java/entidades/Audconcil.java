...
@Entity
@NamedQueries({
	@NamedQuery(name="Audconcil.findConciliadorFecha", query="SELECT a FROM Audconcil a WHERE a.fechasolicitud BETWEEN :fechaini AND :fechafin and a.idconciliador = :identificacion"),
